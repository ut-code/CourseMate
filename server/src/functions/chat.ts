...
import { DMRoomSchema, PersonalizedDMRoomSchema, SendMessageSchema, SharedRoomSchema } from "../common/zod/schemas";

export async function getOverview(id: number): Promise<http.Response<RoomOverview[]>> {
...
export async function sendDM(from: UserID, to: UserID, smsg: SendMessage): Promise<http.Response<Message>> {
...
export async function getDM(requester: UserID, _with: UserID): Promise<http.Response<PersonalizedDMRoom & DMRoom>> {
...
export async function createRoom(creator: UserID, init: InitRoom): Promise<http.Response<SharedRoom>> {
...
export async function getRoom(user: UserID, roomId: ShareRoomID): Promise<http.Response<SharedRoom>> {
...
export async function patchRoom(user: UserID, roomId: ShareRoomID, newRoom: SharedRoom): Promise<http.Response<Omit<SharedRoom, "messages">>> {
